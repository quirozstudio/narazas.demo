...
function homeTemplate() {
  ...
  <section class="compatibility-strip section-pad reveal"><div class="compatibility-head"><p class="section-label">CREATOR FLOW / DEMO</p><h2>Del móvil<br /><em>a tu estilo.</em></h2><p>Recursos pensados para entrar en tu proceso, no para complicarlo.</p></div><div class="compatibility-grid" aria-label="Compatibilidad provisional"><div><strong>CAPCUT</strong><span>Móvil / demo</span></div><div><strong>DAVINCI</strong><span>Desktop / demo</span></div><div><strong>PREMIERE</strong><span>Desktop / demo</span></div><div><strong>VN + MÁS</strong><span>Según formato final</span></div></div></section>
  ...
  <section class="how-it-works section-pad reveal"><div class="how-heading"><p class="section-label section-label--light">CREAR / SIN COMPLICAR</p><h2>Cómo<br /><em>funciona.</em></h2></div><ol class="how-it-works-grid"><li><span class="how-number">01</span><strong>Descarga</strong><p>En la tienda real, recibes tu recurso después de completar la compra.</p></li><li><span class="how-number">02</span><strong>Importa</strong><p>Llévalo a tu editor y sigue la guía rápida de cada producto.</p></li><li><span class="how-number">03</span><strong>Crea</strong><p>Vuelve a tu idea y dale forma con más intención y menos fricción.</p></li></ol></section>
